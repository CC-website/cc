...
export default function EditGroup({ visible, onClose, setOverview, channelId, subchannelId }) {
  ...
  const handleUpdateChannel = async () => {
    try {
        ...
        const url = `${main_url}/api/groups/${setOverview.id}/`;
              ...
              <Image
                source={{
                  uri: setOverview?.image_url
                    ...
                    : ''+main_url+'/group_logos/group.png',
                }}
                style={styles.logo}
              />
            </TouchableOpacity>
