...
export default function EditSubChannel({ visible, onClose, setOverview }) {
  ...
  const handleUpdateChannel = async () => {
    try {
      ...
      const url = `http://192.168.145.37:8000/api/subchannels/${setOverview.id}/`;
      ...
      Alert.alert('Sub Channel Updated', 'Sub Channel updated successfully!');
    } catch (error) {
      // Handle error
      console.error('Error updating channel:', error);
      Alert.alert('Error Updating Sub Channel', 'Error updating channel. Please try again.');
    }
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              // Handle the response as needed
              console.log(response.data);
              Alert.alert('Sub Channel Deleted', 'Sub Channel deleted successfully!');
            } catch (error) {
              // Handle error
              console.error('Error deleting channel:', error);
              Alert.alert('Error Deleting Sub Channel', 'Error deleting channel. Please try again.');
            }
